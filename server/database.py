...
from server import Move_Object, Que_item
...
def get_game_id_by_object(game_object):
	session = make_session()
...
def get_game(id):
	...
	game_object.self_board = get_moves(game.id)
